-- Add mature 2/4/6-week organizational first-pay totals with true,
-- same-length, non-overlapping previous-period comparisons.
...
comment on function public.get_achieve_first_pay_outcomes() is
  'Service-only mature 2/4/6-week and all-time first-pay screening with true non-overlapping organizational comparisons.';
