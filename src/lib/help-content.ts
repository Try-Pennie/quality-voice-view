...
const ENTRIES = {
  ...
  'filter.alerts.status': {
    ...
    title: 'Status filter',
    body:
      'Awaiting manager, awaiting Kris’s approval, changes requested, coaching due, and reviewed are separate dimensions. Changes requested overlap reviewed, and approval does not complete coaching. All includes administrative closures, labeled separately.',
  },
