...
const source = [
  row(),
  row({ agent_email: ' Agent@TryPennie.com ', is_reviewed: true, accurate: true }),
  row({ suggested_disposition: '1.4 - Converted' }),
  row({ is_reviewed: true, accurate: false, suggested_disposition: 'False alarm target' }),
  row({ agent_email: 'other@trypennie.com', suggested_disposition: '1.4 - Converted' }),
  row({ agent_email: null, current_disposition: null, suggested_disposition: null }),
] as const
