...
const rows = [
  { source_as_of: '2026-09-01', cohort_date: '2026-08-18', agent_name: 'Agent A', agent_email: 'A@EXAMPLE.TEST', n: 30, paid: 15, no_deposit: 15, rescinded: 10, never_paid: 5, source_aggregate_rows: 2, source_enrollments: 60 },
  { SOURCE_AS_OF: '2026-09-01', COHORT_DATE: '2026-08-18', AGENT_NAME: 'Agent B', AGENT_EMAIL: 'b@example.test', N: 30, PAID: 24, NO_DEPOSIT: 6, RESCINDED: 1, NEVER_PAID: 5, SOURCE_AGGREGATE_ROWS: 2, SOURCE_ENROLLMENTS: 60 },
]
